...
<!----- [ 디자인 CSS 영역 ] ----->
<link rel="stylesheet" href="/movieWebSite/css/reset.css" type="text/css"> <!-- 리셋 CSS -->
<link rel="stylesheet" href="/movieWebSite/css/style.css" type="text/css"> <!-- 디자인 CSS -->
...
<div id="wrap">
	<div class="banner-top">
		<div class="inner">
			<p><strong>비트영화관</strong>에 오신 것을 환영합니다</p>
			<button></button>
		</div>
	</div><!-- //banner-top -->
	<div id="header" class="sub">		
		<div class="header_top">
			<div class="inner">
				...
				%>
					<!--로그인세션이 없을때 -->
					<span><a href="loginPage.do">로그인</a></span>
					<span><img src="<%=contextPath %>/images/main/header_dot.jpg" alt="·"></span>
					<span><a href="joinPage.do">회원가입</a></span>
					<span><img src="<%=contextPath %>/images/main/header_dot.jpg" alt="·"></span>
				<%
				} else {
				%>
				...
				<h1 class="logo"><a href="mainPage.do">
